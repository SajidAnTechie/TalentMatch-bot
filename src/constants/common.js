...
const viewCallBackIds = {
    ...
    UPDATE_CANDIDATE_INFO_FORM_SUBMISSION: 'update_candidate_info_form_submission',
    REQUEST_INTERVIEWER_FOR_INTERVIEW_FORM_SUBMISSION: 'request_interviewer_for_interview_form_submission',
